...
- [x] 5.4 Record implementation, acceptance, and any deferred-risk evidence in the construction records, then obtain module-level review when the stable implementation commit is ready.
