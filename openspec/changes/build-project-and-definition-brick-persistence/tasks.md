...
- [ ] 1.1 Record the exact implementation baseline, clean-worktree evidence, W3 construction map, slice order, subject identity, and Task/Report paths before product writes begin.
