...
Use when testing or reviewing an implementation subject after later Task/Report commits exist.
...
5. Name both identities in the Report; never silently transfer evidence to a later subject.
